...
inFile  = sys.argv[1]
outFile = "data/" + inFile.split('/')[(len(inFile.split('/'))-1)] + ".fasta" 

print ">> Opening FASTA file..."
# Reads sequence file list and stores it as a string object. Safely closes file:
try:	
	with open(inFile,"r") as newFile:
		sequences = newFile.read() # a variavel "sequences" recebe o arquivo inteiro, na forma de uma string!
...
try:	
	with open(outFile,"w") as newFasta:
		for fasta in sequences:
			...
			## START Modification by Queiroz,L.R.:
